      ...
      <div className={styles.about_page}>
        <div className={styles.content_container}>
          <div className={styles.text_section}>
            ...
            <p>
              <strong>Healthcare Service</strong> is an innovative platform
              offering AI-powered health assistance, smart symptom analysis, and
              a community forum for personalized well-being management. Our AI
              Health Assistant provides instant answers, while the Smart Health
              Checker offers insights into potential conditions.
            </p>
